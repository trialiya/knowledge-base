...
2. Ищи:
   ...
   - если задача требует пройтись по многим файлам и что-то сопоставить или посчитать —
     `runScript` (один скрипт вместо десятка вызовов; справочник ниже). Он только читает.
