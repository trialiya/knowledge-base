...
/**
 * Написанная, но ещё не применённая сводка чата. Зачем такая пауза и почему строка на чат одна —
 * см. шапку миграции {@code V2026.08.30_00__create_chat_pending_summary.sql} и {@code
 * PendingSummaryService}, единственного писателя и читателя этой таблицы.
 *
