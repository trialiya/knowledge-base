...
public class AttachmentService {
    ...
    public Attachment summarize(Long id) {
        ...
        // Re-index with summary for better search quality
        tryIndex(entity);
    ...
    private void tryIndex(AttachmentEntity entity) {
        try {
            ...
            AttachmentEmbeddingEntity emb =
                    embeddingRepo
                            ...
                            .orElseGet(
                                    () -> {
                                        AttachmentEmbeddingEntity e =
                                                new AttachmentEmbeddingEntity();
            ...
            log.warn(
                    "Embedding index failed for attachment id={}: {}",
                    entity.getId(),
                    ex.getMessage());
        }
    }
