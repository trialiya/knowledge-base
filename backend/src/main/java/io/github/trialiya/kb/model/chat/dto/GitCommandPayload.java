 ...
 * ChatMessage} сюда не едет: у этого ряда пустой контент и пустое всё остальное, и отправлять эти
 * поля значило бы обещать, что когда-нибудь они здесь бывают непустыми.
 *
