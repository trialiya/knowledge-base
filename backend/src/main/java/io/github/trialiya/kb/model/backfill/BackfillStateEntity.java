 ...
 *
 * <p>Отметку ставит {@code ProjectStampBackfill} — единственный сейчас потребитель таблицы. Новый
 * бэкфилл заводит своё имя и работает через {@code BackfillStateRepository}, схема не меняется.
 *
 * <p>Ставить отметку — последнее, что делает проход, и только когда прошёл целиком: наличие строки
 * значит «данные приведены к виду, на который чтение вправе рассчитывать», а не «мы это уже
 * запускали».
 *
