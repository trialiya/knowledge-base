...
public class ConversationHub {
     ...
     *
     * <p>Чинить курсор вкладке не нужно: своё «начни заново» она получит на каждой следующей
     * подписке, а нормальным он станет сам — терминальное событие прогона его сбрасывает.
     */
