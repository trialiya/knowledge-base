...
public enum ChatEventType {
    ...
    COMPACT_ERROR,
    /**
     * Фоновая сводка применена: начало истории свёрнуто, в ленте появилась плашка ({@code payload}:
     * {@link CompactPayload}). Прогона за этим событием нет вовсе — сводку написали раньше, а
     * применили в первый подходящий момент (см. {@code PendingSummaryService}), — поэтому и чат оно
     * не занимает, и пузыря себе не заводит: плашка встаёт в середину ленты, туда, где кончается
     * свёрнутое.
     */
    SUMMARY_APPLIED,
    /**
