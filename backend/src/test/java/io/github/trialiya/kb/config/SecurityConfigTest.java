 ...
 * обещала консоль. Тест ловит повторение: с включённой консолью путь должен отвечать через свою
 * цепочку (и её заголовки), а не проваливаться мимо неё в 404 или в основную цепочку.
 *
