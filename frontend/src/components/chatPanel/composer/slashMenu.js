 ...
 *
 * Набранное целиком, без остатка — тоже не место: дополнять нечего, а открытый
 * список съел бы Enter у отправки и закрыл бы собой строку про уже набранную
 * команду. Полный триггер чипа в этот момент подхватывает поиск чипа, полную
 * команду — подсказка над полем.
 *
