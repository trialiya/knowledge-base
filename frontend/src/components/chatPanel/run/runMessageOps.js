 ...
 * Тот же статус покажет и перезагрузка: плашку вызову, которого нет в мете сегмента, синтезирует
 * бэк (ToolCallService#invocationsFor), — так что живой вид и вид из истории совпадают.
 */
