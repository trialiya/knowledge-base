...
export function applyChatEvent(chat, ev, ctx) {
  ...
  switch (type) {
    ...
    // ─── Название чата ──────────────────────────────────────────────────────
    // Название от ИИ (вне прогона, через несколько секунд после RUN_DONE) или
    // переименование из другой вкладки. topic — уже отображаемое название: если
    // чат успели переименовать, это имя пользователя, и затирать его предложенным
    // нельзя.
