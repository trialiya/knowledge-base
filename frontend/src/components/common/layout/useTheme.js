 ...
 * он разрешился (`resolved`: 'light' | 'dark'). Меню спрашивает первое: и
 * галочка, и иконка метят выбор, иначе «как в системе» не отличить от руками
 * выбранной светлой. Второе нужно тому, что рисует не средствами CSS и обязано
 * знать, светло сейчас или темно.
 *
