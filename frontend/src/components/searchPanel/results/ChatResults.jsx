 ...
 *
 * Сообщение занимает две строки — подпись «кто и когда» и текст под ней, — как
 * раздел документа и его совпадения: подпись отвечает на «где это сказано», а
 * место под текст остаётся всё. У документа группа — раздел с несколькими
 * строками, здесь у подписи всегда одна: сообщение и есть её содержимое.
 *
