...
function App() {
  ...
  // Запрос показывает тот раздел, который сейчас его отрабатывает: единый поиск
  // или (по старой ссылке) поиск базы знаний.
  const navQuery = view === 'search' ? nav.searchQuery : nav.search;
