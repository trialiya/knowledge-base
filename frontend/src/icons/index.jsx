...
/** Левый шеврон (навигация «назад», сворачивание правой панели). */
export const IconChevronLeft = ({ size = 10 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...s} strokeWidth="2.5">
...
/** Тумблер правой панели рабочей области (прямоугольник с выделенной правой колонкой). */
export const IconPanelRight = ({ size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...s} strokeWidth="1.8">
    <rect x="3" y="4" width="18" height="16" rx="2" />
