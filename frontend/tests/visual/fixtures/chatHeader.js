 ...
 * контекст 11k при total input 31.1k за три обращения, из них 24k из кэша. Разрыв между занятым
 * контекстом и суммарным входом здесь не случайность, а суть показанного (см. RunTokenUsage).
 */
