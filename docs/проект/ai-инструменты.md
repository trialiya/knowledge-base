...
- **Ограничения:** 
  - Инструмент доступен, только когда проект принимает запись (`kb.projects[].edit-enabled`, по умолчанию `kb.git.edit-enabled`) И его рабочее дерево доступно на запись
...
- **Ограничения:**
  - Доступен, только когда проект принимает запись (`kb.projects[].edit-enabled`, по умолчанию `kb.git.edit-enabled`) И его рабочее дерево доступно на запись
