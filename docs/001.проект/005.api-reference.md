...
> **Связанные документы:** [Введение](001.введение.md) · [Архитектура](002.архитектура.md) · [Модели данных](004.модели-данных.md) · [AI-инструменты](006.ai-инструменты.md) · [Конфигурация](007.конфигурация.md) · [Руководство по установке](008.руководство-по-установке.md)
...
Обновить документ. Сохраняет снапшот в `document_history` перед обновлением. Использует оптимистичную блокировку.
